...
/**
 * Pardot Map config.php
 *
 * This file exists only as a template for the Pardot Map settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'pardot-map.php'
